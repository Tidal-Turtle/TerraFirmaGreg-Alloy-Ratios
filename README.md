...
## Recipe mode
As of v0.3, TFG-AR has implemented the 'Recipe mode'. Recipe mode gives you the number of ores you need to create an alloy. It takes into account the ratio ranges of every ore in order for the smelted metal to turn into an alloy, the amount of mB every ore gives and the number of ingots that you want.
